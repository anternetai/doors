 ...
 * Uses Google Places API (New) when GOOGLE_PLACES_API_KEY is set, else free Photon.
 */
    ...
    try {
      const r = await fetch("https://places.googleapis.com/v1/places:autocomplete", {
        ...
        body: JSON.stringify({
          ...
          locationBias: { circle: { center: { latitude: CLT.lat, longitude: CLT.lng }, radius: 50000 } },
        }),
      })
      if (r.ok) {
